...
export default function DowBarChart({ dowEffect }: { dowEffect: DowRow[] }) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
      <h3 className="text-sm font-semibold text-slate-700 mb-1">요일별 평균 매출</h3>
      <p className="text-xs text-slate-400 mb-4">점선: 전체 평균  |  주황: 주말</p>
            ...
            content={({ active, payload, label }) => {
              ...
              return (
                <div className="bg-white border border-slate-200 shadow-md rounded-lg px-3 py-2 text-xs">
                  <p className="font-semibold text-slate-700">{String(label)}요일</p>
